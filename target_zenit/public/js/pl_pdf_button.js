// pl_pdf_button.js — Target Zenit
// P&L Statement sahifasiga "Custom PDF" tugmasini qo'shadi.
// Frappe SPA navigatsiyasidan omon qoladi (frappe.tz.patch_report).
(function () {
    "use strict";

    var REPORT_NAME = "Profit and Loss Statement";
    var BTN_CLASS = "btn-tz-pl-pdf";
    ...
    function _on_click() {
        ...
        frappe.call({
            method: "target_zenit.target_zenit.api.pl_pdf_api.generate_pl_pdf",
